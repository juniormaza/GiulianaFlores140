...
class Teste_usuario_negativo():
    ...
    def test_criar_usuario(self):           # método de teste
        ...
        # preencher senha
        self.driver.find_element(By.ID, "ContentSite_txtPassword").send_keys("Orakun1234567")
        # clica no botão continuar
        self.driver.find_element(By.CSS_SELECTOR, "#ContentSite_ibtContinue").click
        # validar mensagem de erro
        assert self.driver.find_element(By.CSS_SELECTOR, "div.giuliana2013:nth-child(9) div.content_checkout div:nth-child(2) span.aviso-erro > span.font_erro:nth-child(2)").text == " e-mail ou senha inválidos!"